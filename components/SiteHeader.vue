<template>
  <header class="sticky top-0 z-20 py-4 bg-white container">
    <div class="flex flex-wrap justify-between items-center gap-x-4 gap-y-2 pb-2 border-b-2 border-black">
