  ...
  <div ref="elContainer" class="mb-6 py-20 text-sm grid grid-cols-2 md:grid-cols-3 gap-x-20 gap-y-40 relative">
    <div v-for="project in projects" :key="project.id" class="flex justify-center">
      <NuxtLink
        ...
        class="inline-flex flex-col items-center gap-1 relative h-40 p-4"
      ...
      >
        <svg v-if="project.title === 'Walk the Plank'" fill="currentColor" viewBox="-2 -2 143 139" class="h-full">
        ...
        <svg v-else-if="project.title === 'Purcell'" viewBox="0 0 69 97" fill="currentColor" class="h-full">
        ...
        <svg v-else-if="project.title === 'Silures'" viewBox="-0.5 0 57 59" fill="currentColor" class="h-full">
          <path
        ...
        <svg v-else-if="project.title === 'Studio Treble'" viewBox="0 0 108 150" fill="currentColor" class="h-full">
          <path
        ...
        <svg v-else-if="project.title === 'Brighter Sound'" viewBox="0 0 73 132" class="h-full" fill="currentColor">
          <path
        ...
        <img v-else src="/file.svg" class="h-full">
